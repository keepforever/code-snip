  ...
  deleteSnippit = (id) => {
    ...
    this.props.deleteSnippit({
      ...
      update: (store) => {
        ...
        data.snippitsConnection.edges = data.snippitsConnection.edges.filter(s => s.node.id !== id);
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({selectSnippitAction: selectSpecificSnippit}, dispatch)
}
